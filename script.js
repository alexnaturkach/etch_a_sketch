...
const contSize = 45; //size of container in pixels
let size = 16; //number of columns and rows
let mouseDown = false; //check if mouse is clicked when hovering
let drawingMethod = drawBlack; //variable to switching functions between drawing colors
